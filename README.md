...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/jupyterlab-spellchecker-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12414&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/jupyterlab-spellchecker-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `jupyterlab-spellchecker` can be installed with:

```
conda install jupyterlab-spellchecker
```

It is possible to list all of the versions of `jupyterlab-spellchecker` available on your platform with:
